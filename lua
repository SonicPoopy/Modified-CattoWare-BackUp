...
library.theme = {
    ...
    bordercolor = Color3.fromRGB(8,37,209),
    accentcolor = Color3.fromRGB(8,37,209),
    accentcolor2 = Color3.fromRGB(8,37,209),
    outlinecolor = Color3.fromRGB(8,37,209),
    outlinecolor2 = Color3.fromRGB(0, 0, 0),
    sectorcolor = Color3.fromRGB(8,37,209),
        ...
        function tab:CreateSector(name,side)
            ...
            function sector:AddToggle(text, default, callback, flag)
                ...
                function toggle:AddColorpicker(default, callback, flag)
                    ...
                    colorpicker.Main.Size = UDim2.fromOffset(15, 10)

                    colorpicker.Gradient = Instance.new("UIGradient", colorpicker.Main)
                    colorpicker.Gradient.Rotation = 105
